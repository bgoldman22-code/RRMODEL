...
// Complete NFL Player Data Collection - All 32 Teams - FIXED VERSION
...
// Complete roster data for all 32 teams
...
async function main() {
  ...
  try {
    ...
    // FIXED: Pass the actual variables instead of undefined nested references
    const storeResults = await storeAllData({
      ...
      targetShares,
      recentWeeks,
      comprehensiveData  // NOW CORRECTLY PASSED
    });
...
// FIXED: storeAllData function now properly accesses passed data
