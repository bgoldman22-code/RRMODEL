...
// Load current rosters from depth-charts.json
async function loadCurrentRosters() {
  try {
  console.log('📖 Reading current rosters from history/2025/week3/depth-charts.json...');
  ...
  console.error('❌ Failed to load history/2025/week3/depth-charts.json:', error);
...
async function main() {
  ...
  try {
    ...
    try {
      // Load current rosters from history/2025/week3/depth-charts.json
      console.log('\n📋 Loading CURRENT NFL rosters from history/2025/week3/depth-charts.json...');
