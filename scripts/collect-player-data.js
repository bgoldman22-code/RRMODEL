...
// Complete NFL Player Data Collection - All 32 Teams
...
async function main() {
  ...
  try {
    ...
    // Add missing teams to complete the 32
    addRemainingTeams(teamRosters);
...
function addRemainingTeams(teamRosters) {
  const remaining = {
    'GB': {
  ...
  Object.assign(teamRosters, remaining);
}
