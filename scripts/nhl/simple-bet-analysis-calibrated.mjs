...
const predsPath = path.join(REPO_ROOT, 'data/nhl/walkforward_backtest_calibrated_results.json');

console.log('╔════════════════════════════════════════════════════════════════════╗');
console.log('║       📊 CALIBRATED BET ANALYSIS (Model vs Line)                  ║');
console.log('╚════════════════════════════════════════════════════════════════════╝\n');
...
// Save results
const resultsPath = path.join(REPO_ROOT, 'data/nhl/calibrated_bet_analysis.json');
