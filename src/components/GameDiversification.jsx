...
/**
 * Safe add-on table. It depends ONLY on props and will not crash if data is missing.
 *
 * Props:
 *  - selected: array of current Top 12 (or whatever you pass)
 *  - candidates: full array of ranked candidates (highest EV first)
 *  - targetGames: number (default 8)
 *
 * Each row expects fields used in your tables:
 *   { name, game, p_model, american, ev, why, park }
 */
