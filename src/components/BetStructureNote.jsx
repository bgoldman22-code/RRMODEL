...
/** Text-only banner with recommended RR structure (safe to drop anywhere). */
export default function BetStructureNote(){
  return (
    <div className="mb-4 rounded-lg border p-3 text-sm bg-white">
      <div className="font-semibold mb-1">Recommended round-robin structure</div>
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li>Don’t force 1/game — double up in juicy games; use “Game diversification” picks to widen coverage.</li>
      </ul>
    </div>
  );
}
