...
def main():
    ...
    # FIX P2-7: Canonical feature column source.
    # ALWAYS use explicit exclusion list to ensure Option A enforcement.
    # Note: Parquet attrs are unreliable — use canonical exclusion list.
    EXCLUDE_COLS = [
    ...
    print(f"   ✅ Using canonical Option A feature list (n={len(feature_cols)})")
