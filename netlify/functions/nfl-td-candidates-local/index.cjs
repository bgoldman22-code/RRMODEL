...
// Keep TD logic minimal here; we'll fill with real model after schedule is live
exports.handler = async (event) => {
  try {
    ...
    return { statusCode: 200, headers: { 'content-type': 'application/json' }, body: JSON.stringify({ ok:true, season: sched.season, week: parseInt(weekStr,10), teams: Array.from(teams), meta: { source } }) };
  } catch (err) {
